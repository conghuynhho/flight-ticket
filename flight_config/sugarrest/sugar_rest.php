...
class Sugar_REST {
	...
	*/
	...
	private $rest_url = "http://np2020.vietnamairlines.website/service/v2/rest.php";
	// private $rest_url = "http://bak01.vietnamairlines.website/service/v2/rest.php";
	/**
	* Variable:	$username
	...
	*/
	...
	private $username = "timcbcom";
	/**
	* Variable:	$password
	* Description:	The password for the $username SugarCRM account
	*/
	private $password = "BrumEsPIS^78lxU0roMuYaB!Sw";
