        ...
        <div class="row">
            <div class="col-md-5 col-sm-5 col-xs-12">
                <div class="homeWidgetWrap blueBg searchForm" id="flighttab">
                    ...
                    <form class="search-flight-form" method="post" action="<?php echo _page('flightairticket'); ?>" id="frmFlightSearch" name="frmFlightSearch">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label>Nơi đi</label>
                                <input name="depinput" type="text" id="depinput" class="form-control depart desktop-input desktop-input-mobile hidden-xs" placeholder="Nơi đi" value="Hồ Chí Minh (SGN)">
                                <!-- MOBILE -->
                                <div class="go-flight-from go-flight visible-xs visible-md">
                                    <input type="text" class="form-control depart mobile-input button-click" id="depmobileinput" name="depmobileinput" placeholder="Nhập tên điểm khởi hành" value="Hồ Chí Minh (SGN)" readonly>
                                    <div id="listCityDep" class="direction-panel-xpanel sub-departure-mobile visible-lg">
                                        <div class="xheading">
                                            <button type="button" class="xclose">Quay lại</button>
                                            <div class="title-panel">Chọn điểm đi</div>
                                        </div>
                                        <div class="airport-search-box-mobile">
                                            <input value="" id="inter-city-dep-mobile" style="width:100%" autocomplete="off" class="form-control ac_city" placeholder="Tìm theo tên thành phố, mã, quốc gia ..." type="text">
                                        </div>
                                        <div id="sub-departure-mobile">
                                            <div class="scroll-touch">
                                                <?php echo getCityMobile($GLOBALS['FULL_AIRPORT_GROUP_MOBILE']); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!--- DESKTOP -->
                            <div id="listDep" class="listcity list-airports-direction list-direction-animate hidden-xs">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label>Nơi đến</label>
                                <input name="desinput" type="text" id="desinput" class="form-control arrival desktop-input desktop-input-mobile hidden-xs" placeholder="Nơi đến" value="Hà Nội (HAN)">
                                <!-- MOBILE -->
                                <div class="go-flight-from go-flight visible-xs visible-md">
                                    <input type="text" class="form-control arrival mobile-input button-click" id="desmobileinput" name="desmobileinput" placeholder="Nhập tên điểm đến" value="Hà Nội (HAN)" readonly>
                                    <div id="listCityDes" class="direction-panel-xpanel sub-arrival-mobile visible-lg">
                                        <div class="xheading">
                                            <button type="button" class="xclose">Quay lại</button>
                                            <div class="title-panel">Chọn điểm đến</div>
                                        </div>
                                        <div class="airport-search-box-mobile">
                                            <input value="" id="inter-city-arv-mobile" style="width:100%" autocomplete="off" class="form-control ac_city" placeholder="Tìm theo tên thành phố, mã, quốc gia ..." type="text">
                                        </div>
                                        <div id="sub-arrival-mobile">
                                            <div class="scroll-touch">
                                                <?php echo getCityMobile($GLOBALS['FULL_AIRPORT_GROUP_MOBILE']); ?>
                                            </div>
                                        </div>
                            ...
                            <div id="listDes" class="listcity listcity list-airports-direction list-direction-animate hidden-xs">
                                <div class="suggestion-container hidden-xs">
                                    <div class="tcb-hot-city-box">
                                        <div class="tcb-hot-city-box-cnt">
                                            <div class="tcb-hot-city-box-tit">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <input name="codedeparture" type="hidden" id="dep" value="SGN">
                            <input name="codedestination" type="hidden" id="des" value="HAN">
                            <input name="datefrom" type="hidden" id="datefrom" value="<?php echo $deptime_tmp; ?>">
                            <input name="dateto" type="hidden" id="dateto" value="--/--/----">
                            <input name="adultNo" type="hidden" id="adultNo" value="1">
                            <input name="childNo" type="hidden" id="childNo" value="0">
                            <input name="infantNo" type="hidden" id="infantNo" value="0">
                        </div>
                    </form>
                </div>
            </div>
